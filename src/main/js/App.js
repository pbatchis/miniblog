...
class App extends React.Component {
  ...
  buildMainView() {
    switch (this.state.viewMode) {
      ...
      case "RegisterView":
        return <RegisterView onRegisterSuccess={this.handleRegisterSuccess} />;
      case "RegisterSuccessView":
        return <RegisterSuccessView onSignIn={this.handleSignIn} />;
      case "SignInView":
        return <SignInView onSignInSuccess={this.handleSignInSuccess} />;
      default:
        return null;
    }
  }
